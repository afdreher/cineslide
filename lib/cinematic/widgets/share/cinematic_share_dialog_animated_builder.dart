...
/// The animation builder of [CinematicShareDialog].
class CinematicShareDialogAnimatedBuilder extends StatelessWidget {
  const CinematicShareDialogAnimatedBuilder({
    Key? key,
    ...
    return AnimatedBuilder(
      ...
      builder: (context, child) {
        return builder(
          context,
          child,
          CinematicShareDialogEnterAnimation(animation as AnimationController),
        );
      },
      child: child,
    );
...
typedef MyTransitionBuilder = Widget Function(
  ...
  Widget? child,
  CinematicShareDialogEnterAnimation animation,
);

class CinematicShareDialogEnterAnimation {
  CinematicShareDialogEnterAnimation(this.controller)
