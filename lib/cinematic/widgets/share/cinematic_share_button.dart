...
/// {@endtemplate}
class CinematicTwitterButton extends StatelessWidget {
  /// {@macro dashatar_twitter_button}
  const CinematicTwitterButton({Key? key}) : super(key: key);
...
/// {@endtemplate}
class CinematicFacebookButton extends StatelessWidget {
  /// {@macro dashatar_facebook_button}
  const CinematicFacebookButton({Key? key}) : super(key: key);
...
/// {@endtemplate}
@visibleForTesting
class CinematicShareButton extends StatefulWidget {
  /// {@macro dashatar_share_button}
  const CinematicShareButton({
    Key? key,
  ...
  @override
  State<CinematicShareButton> createState() => _CinematicShareButtonState();
}

class _CinematicShareButtonState extends State<CinematicShareButton> {
